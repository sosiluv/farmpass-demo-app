    ...
    <div className="fixed top-4 right-4 md:right-16 z-50">
      <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
        <PopoverTrigger asChild>
          <button
            className="relative p-2 rounded-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
        ...
        <PopoverContent className="w-80 p-0 border-0 shadow-2xl bg-white/95 dark:bg-gray-900/95 backdrop-blur-md rounded-xl">
          {/* 헤더 */}
