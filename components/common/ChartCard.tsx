 ...
 * =================================
 *
 * 🎯 목적: 모든 admin 페이지에서 공통으로 사용할 수 있는 차트 카드
 * 📍 위치: /components/common/ChartCard.tsx
 * 🔄 대체:
 *   - /components/admin/dashboard/ChartGrid/ChartCard.tsx
 *   - /components/admin/management/dashboard/ChartCard.tsx
 *
 * ✨ 특징:
 *   - 4가지 variant 지원 (default, success, warning, info)
 *   - 다크모드 완전 지원
 *   - 아이콘 및 커스텀 스타일링 지원
 *   - 반응형 디자인
 */
