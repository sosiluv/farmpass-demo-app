...
export function VisitorDetailSheet({
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      {/* 헤더 */}
      <div className="flex flex-col items-center space-y-3 sm:space-y-4 pb-3 sm:pb-4 flex-shrink-0 border-b border-gray-100">
        <VisitorAvatar
        ...
        <div className="space-y-3 sm:space-y-4 pb-2">
          ...
          <Card className="bg-gradient-to-br from-gray-50 to-white border border-gray-200/60">
            <CardHeader className="pb-2 sm:pb-3">
              <CardTitle className="text-sm sm:text-base font-semibold flex items-center space-x-2 text-gray-700">
            ...
            <CardContent className="space-y-2 sm:space-y-3 pt-0">
              ...
              <div className="flex items-start space-x-2 sm:space-x-3 p-2 sm:p-3 bg-white/80 rounded-lg border border-gray-100">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm sm:text-base font-semibold text-gray-800 leading-relaxed break-all">
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-white border border-blue-200/60">
            <CardHeader className="pb-2 sm:pb-3">
              <CardTitle className="text-sm sm:text-base font-semibold flex items-center space-x-2 text-blue-700">
            ...
            <CardContent className="space-y-2 sm:space-y-3 pt-0">
              <div className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 bg-white/80 rounded-lg border border-blue-100">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {(() => {
                    ...
                    return (
                      <div>
                        <p className="text-sm sm:text-base font-bold text-blue-800 leading-tight">
                          {datePart}
                        </p>
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 bg-white/80 rounded-lg border border-blue-100">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm sm:text-base font-bold text-blue-800 break-all">
                    {visitor.farms?.farm_name || LABELS.VISITOR_DETAIL_UNKNOWN}
                  </p>
                  {visitor.farms?.farm_type && (
                    <Badge
                      variant="secondary"
                      className="mt-1 text-xs sm:text-sm bg-purple-100 text-purple-700 border-purple-200"
                    >
              ...
              <div className="flex items-start space-x-2 sm:space-x-3 p-2 sm:p-3 bg-white/80 rounded-lg border border-blue-100">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm sm:text-base font-bold text-blue-800 leading-relaxed break-all">
          ...
          <Card className="bg-gradient-to-br from-green-50 to-white border border-green-200/60">
            <CardHeader className="pb-2 sm:pb-3">
              <CardTitle className="text-sm sm:text-base font-semibold flex items-center space-x-2 text-green-700">
          ...
          {visitor.notes && (
            <Card className="bg-gradient-to-br from-amber-50 to-white border border-amber-200/60">
              <CardHeader className="pb-2 sm:pb-3">
                <CardTitle className="text-sm sm:text-base font-semibold flex items-center space-x-2 text-amber-700">
              ...
              <CardContent className="pt-0">
                <div className="p-2 sm:p-3 bg-white/80 rounded-lg border border-amber-100">
                  <p className="text-sm sm:text-base font-semibold text-amber-800 leading-relaxed break-all">
                    {visitor.notes}
                  </p>
                </div>
              </CardContent>
