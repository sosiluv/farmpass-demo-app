    ...
    >
      ...
      <CardContent className="p-3 sm:p-4 md:p-5 min-h-[120px] sm:min-h-[140px] md:min-h-[160px]">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between h-full">
          <div className="flex items-center space-x-1.5 sm:space-x-2 md:space-x-3 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              <p
                className={`text-sm sm:text-base md:text-lg font-medium ${textColor} opacity-80 truncate mb-1`}
              >
                {title}
              </p>
              <p className="text-xs sm:text-sm md:text-base text-muted-foreground hidden lg:block">
                {description}
              </p>
            </div>
          </div>
          <div className="text-right md:text-right md:flex-shrink-0 md:ml-2 mt-2 md:mt-0">
            <div
              className={`text-lg sm:text-2xl md:text-3xl lg:text-3xl font-bold ${textColor} leading-none whitespace-nowrap`}
            >
            ...
            <Badge
              variant="secondary"
              className={`${bgColor} ${textColor} border-none text-xs sm:text-sm font-medium px-2 py-1 mt-2 hidden lg:inline-flex`}
            >
              {trend}
            </Badge>
          </div>
        ...
        <div className="flex items-center justify-between mt-3 sm:mt-4 lg:hidden">
          ...
          <Badge
            variant="secondary"
            className={`${bgColor} ${textColor} border-none text-xs sm:text-sm font-medium px-2 py-1`}
          >
            {trend}
          </Badge>
        </div>
